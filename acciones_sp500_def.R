...
autoplot(information_technology_arima_forecast) +
  ...
  xlab("Año") +
  ylab("Valor") +
  ggtitle("Predicción Information Technology Industry ARIMA(2,1,0)") +
  scale_y_continuous(labels = dollar_format(prefix = "$"))
...
arima_materials_1 <- Arima(ts_data_materials, order = c(2,1,2),seasonal = list(order = c(1,1,1), period = 12))
...
autoplot(materials_arima_forecast) +
  ...
  xlab("Año") +
  ylab("Valor") +
  ggtitle("Predicción Materials Industry ARIMA (2,1,2)") +
  scale_y_continuous(labels = dollar_format(prefix = "$"))
...
arima_utilities_1 <- Arima(ts_data_utilities, order = c(1,1,1), seasonal = list(order = c(1,1,1), period = 12))
...
autoplot(utilities_arima_forecast) +
  ...
  xlab("Año") +
  ylab("Valor") +
  ggtitle("Predicción Utilities Industry ARIMA (1,1,1)") +
  scale_y_continuous(labels = dollar_format(prefix = "$"))
...
autoplot(financials_arima_forecast) +
  ...
  xlab("Año") +
  ylab("Valor") +
  ggtitle("Predicción Financials Industry - ARIMA (2,1,0)") +
  scale_y_continuous(labels = dollar_format(prefix = "$"))

accuracy(arima_financials_1)


D# Energy Industry - ARIMA -------------------------------------------------
...
arima_energy_1 <- Arima(ts_data_energy, order = c(2,1,0), seasonal = list(order = c(2,1,0), period = 15))
...
autoplot(energy_arima_forecast) +
  ...
  xlab("Año") +
  ylab("Valor") +
  ggtitle("Predicción Energy Industry - ARIMA (2,1,0)") +
  scale_y_continuous(labels = dollar_format(prefix = "$"))
